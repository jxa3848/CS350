...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        ...
        self.updateLights() # this changes the lights when mode is heat
        if(DEBUG):
    ...
    def on_exit_heat(self):
        ...
        redLight.off() # when not active turns red light off
    ##
    ...
    def on_enter_cool(self):
        ...
        self.updateLights()# this changes the lights when mode is cool
        if(DEBUG):
    ...
    def on_exit_cool(self):
        ...
        blueLight.off() # when cool is not active turns off blue light
    ##
    ...
    def on_enter_off(self):
        ...
        redLight.off()
        blueLight.off()# when in off state sets these paramiters
        if(DEBUG):
    ...
    def processTempStateButton(self):
        ...
        self.send("cycle") # uses the order we set to change the state from off to heat then cool finally back to off
    ##
    ...
    def processTempIncButton(self):
        ...
        self.setPoint = self.setPoint + 1 # when button pressed adds 1 to the set point
        self.updateLights()
    ##
    ...
    def processTempDecButton(self):
        ...
        self.setPoint = self.setPoint -1# when button pressed subtracts  1 to the set point
        self.updateLights()
    ##
    ...
    def updateLights(self):
        ...
        ## this where we set the lights to pulse depending on the state and the actual temp compared to the set temp
    ...
    def setupSerialOutput(self):
        ## sends the state the temp and set point through the usb to the serial
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            ##
            #sets the current time on line 1
            lcd_line_1 = current_time.strftime('%b %d %H:%M:%S\n')
            ## Setup Display Line 2
            if(altCounter < 6):
                ##
                # shows the temp on line 2 of the display
                lcd_line_2 = f"t:{self.getFahrenheit():0.1f}F"
                altCounter = altCounter + 1
            else:
                ##
                    # shows the current state and set point on line 2
...
##
# sets what the blue button does
